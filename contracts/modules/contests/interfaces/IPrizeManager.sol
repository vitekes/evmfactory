...
interface IPrizeManager {
    ...
    function addTemplate(PrizeInfo[] calldata slots, string calldata description) external returns (uint256 templateId);
    ...
    function updateTemplate(uint256 templateId, PrizeInfo[] calldata slots, string calldata description) external;
    ...
    function getTemplate(
        uint256 templateId
    ) external view returns (PrizeInfo[] memory slots, string memory description);
}
