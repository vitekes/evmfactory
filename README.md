...
- **PaymentSystemRoleManager** - централизованный менеджер ролей
...
3. **Управление ролями**:
   - `PaymentSystemRoleManager` предоставляет централизованное управление доступом
   - Роли могут быть как для процессоров, так и системными
